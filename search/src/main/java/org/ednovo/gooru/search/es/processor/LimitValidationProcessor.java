...
public class LimitValidationProcessor extends SearchProcessor<SearchData, Object> {
	...
	public void process(SearchData searchData,
		...
		Map<String, String> limitSearchCallCache = getRedisService().get(cacheKeyIP) != null ? JsonDeserializer.deserialize(getRedisService().get(cacheKeyIP), new TypeReference<Map<String, String>>() {}) : null;
