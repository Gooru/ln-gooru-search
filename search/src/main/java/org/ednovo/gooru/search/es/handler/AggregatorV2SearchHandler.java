...
import static org.ednovo.gooru.search.es.processor.SearchProcessorType.AttributionDeserializer;
...
import static org.ednovo.gooru.search.es.processor.SearchProcessorType.AggregatorDeserializer;
...
@Component
public class AggregatorV2SearchHandler extends SearchHandler<SearchData, Map<String, Object>> {

	private static final SearchProcessorType[][] searchProcessorTypes = new SearchProcessorType[][] { { BlackListQueryValidation }, { LimitValidation }, { EsDslQueryBuild }, { Elasticsearch }, { AggregatorDeserializer} };
	...
	protected SearchHandlerType getType() {
		return SearchHandlerType.AGGREGATOR;
	}
