...
import static org.ednovo.gooru.search.es.processor.SearchProcessorType.TaxonomyDeserializer;
 ...
 */
@Component
public class TaxonomyV2SeachHandler extends SearchHandler<SearchData, Map<String, Object>> {

	private static final SearchProcessorType[][] searchProcessorTypes = new SearchProcessorType[][] { { BlackListQueryValidation },
			{ LimitValidation }, { TaxonomyFilterConstruction }, { EsDslQueryBuild }, { EsSuggestDslQueryBuild }, { Elasticsearch },
	...
	protected SearchHandlerType getType() {
		return SearchHandlerType.TAXONOMY;
	}
