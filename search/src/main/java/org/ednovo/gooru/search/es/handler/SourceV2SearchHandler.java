 ...
 */
@Component
public class SourceV2SearchHandler extends SearchHandler<SearchData, Map<String, Object>> {

	private static final SearchProcessorType[][] searchProcessorTypes = new SearchProcessorType[][] { { BlackListQueryValidation }, { LimitValidation }, { EsDslQueryBuild },{EsSuggestDslQueryBuild}, 
			{ Elasticsearch }, { AttributionDeserializer } };
	...
	protected SearchHandlerType getType() {
		return SearchHandlerType.SOURCE;
	}
