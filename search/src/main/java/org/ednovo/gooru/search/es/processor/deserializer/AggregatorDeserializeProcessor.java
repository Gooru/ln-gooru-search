...
@Component
public class AggregatorDeserializeProcessor <O extends Set<Map<String, Object>>, S extends Map<String, Object>> extends DeserializeProcessor<O, S> {{
 ...
 O deserialize(Map<String, Object> model, SearchData input, O output) {
		...
		for (Map<String, Object> hit : hits) {
			...
			values.add((String) fields.get(AGGREGATOR_NAME));
		}	
...
protected SearchProcessorType getType() {
	...
	return SearchProcessorType.AggregatorDeserializer;
}
}