 ...
 */
@Component
public class AttributionV2SearchHandler extends SearchHandler<SearchData, Map<String, Object>> {

	private static final SearchProcessorType[][] searchProcessorTypes = new SearchProcessorType[][] { { BlackListQueryValidation }, { LimitValidation }, { EsDslQueryBuild }, { Elasticsearch }, { AttributionDeserializer } };
	...
	protected SearchHandlerType getType() {
		return SearchHandlerType.ATTRIBUTION;
	}
