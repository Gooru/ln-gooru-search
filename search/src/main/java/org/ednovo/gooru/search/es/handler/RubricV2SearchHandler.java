...
public class RubricV2SearchHandler extends SearchHandler<SearchData, Map<String, Object>> {
	...
	private static final SearchProcessorType[][] searchProcessorTypes = new SearchProcessorType[][] { { BlackListQueryValidation }, { LimitValidation }, { RubricFilterConstruction },
			{ EsDslQueryBuild }, { Elasticsearch }, { RubricDeserializeProcessor } };
