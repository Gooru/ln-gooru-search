...
@Component
public class CrosswalkV2SearchHandler extends SearchHandler<SearchData, List<Map<String,Object>>>  {
	...
	protected SearchHandlerType getType() {
		return SearchHandlerType.CROSSWALK;
	}

	@Override
	protected EsIndex getIndexType() {
		return EsIndex.CROSSWALK;
	}
